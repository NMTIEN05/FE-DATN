...
const fallbackBanners = [
    ...
    },
    {
        ...
        title: "oppo - Find X5",
        link: "#",
        image: "https://tse3.mm.bing.net/th/id/OIP.vAgTEpy5SUpnFK4Bi3DwUAHaEK?pid=Api&P=0&h=180",
    },
];
...
const leftMenu = [
    ...
    { id: 7, name: "Thu cũ đổi mới", icon: <FaSyncAlt />, link: "/exchange" },
    {
        id: 8,
...
const BannerSection: React.FC<BannerSectionProps> = ({
    ...
    const mapped = (apiBanners?.length ? apiBanners : fallbackBanners).map(
        (b: any) => ({
            ...b,
            image: toAbs(b.image),
        })
    ...
    const sideList = (mapped.length > 1 ? mapped.slice(1, 4) : []).map((b) => ({
        ...b,
    }));
            ...
            <div className="grid grid-cols-12 gap-4">
                                                ...
                                                <a href={banner.link || "#"}>
                                                    <img
                                                        ...
                                                        onError={(e) => {
                                                            ...
                                                            e.currentTarget.src =
                                                                "https://placehold.co/1200x420?text=Banner";
                                                        }}
                                                    />
                                                </a>
                                            </SwiperSlide>
                ...
                <div className="col-span-12 md:col-span-3">
                    <div className="h-[420px] flex flex-col gap-3">
                        {(sideList.length ? sideList : fallbackSide).map(
                            (banner: any, i: number) => (
                                <a
                                ...
                                >
                                    <img
                                        ...
                                        onError={(e) => {
                                            ...
                                            e.currentTarget.src =
                                                "https://placehold.co/380x160?text=Side+Banner";
                                        }}
                                    />
                                </a>
                            )

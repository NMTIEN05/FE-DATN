...
const Header = () => {
    ...
    const handleSearch = () => {
        if (search.trim()) {
            ...
            setSearch(""); // nếu muốn clear sau khi search
        }
    };
    useEffect(() => {
    ...
    return (
        <header className="z-50">
            ...
            >
                <div className="container mx-auto px-10 flex items-center justify-between flex-wrap gap-y-2">
                    ...
                    <div className="flex items-center space-x-3 text-sm order-3 ml-auto">
                        <Link
                            to="/contact"
                            className="flex items-center text-gray-700 hover:text-blue-600 px-2 group"
                        >
                        ...
                        <Link
                            to="/favorites"
                            className="flex items-center text-gray-700 hover:text-blue-600 relative px-2 group"
                        >
                        ...
                        {isLoggedIn ? (
                            <div className="relative px-2">
                                ...
                                >
                                    ...
                                    <FaChevronDown
                                        className={`text-xs mt-[1px] transform transition-transform ${
            ...
            {isMobileMenuOpen && (
                ...
                >
                    <div
                        className="fixed top-0 left-0 w-80 h-full bg-white z-40 shadow-lg"
                    ...
                    >
                        ...
                        <nav className="flex flex-col p-4 space-y-2">
                            ...
                            <div className="pt-2 border-t">
                                ...
                                <Link
                                    to="/thuong-hieu/apple"
                                    className="flex items-center text-gray-700 hover:text-blue-600 py-2 pl-4"
                                    onClick={() => setIsMobileMenuOpen(false)}
                                >
                                    <IoLogoApple className="mr-3 text-xl" />{" "}
                                    Apple
                                </Link>
                                <Link
                                    ...
                                    onClick={() => setIsMobileMenuOpen(false)}
                                >
                                    <SiSamsung className="mr-3 text-xl" />{" "}
                                    Samsung
                                </Link>
                                <Link
                                    to="/thuong-hieu/xiaomi"
                                    className="flex items-center text-gray-700 hover:text-blue-600 py-2 pl-4"
                                    onClick={() => setIsMobileMenuOpen(false)}
                                >
            ...
            <div className="bg-blue-100 pb-2 md:pb-0">
                <nav
                    ...
                    style={{ marginTop: fixedHeaderHeight, height: "40px" }}
                >
                    <div className="flex items-center space-x-6">
                        <Link
                            to="/"
                            className="flex items-center text-gray-800 hover:text-blue-600 px-3 py-1"
                        >
